      ...
      <section class="main" id="top">
        ...
        <section class="py-xxl-10 pb-0" id="home">
          <div
            ...
            style={{
              background: `url('https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/hero-bg.png')`,
            ...
            <div class="row">
              <div class="col-12 py-3">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url(assets/img/gallery/bg-departments.png);background-position:top center;background-size:contain',
                  }}
                >
                  <img
                    style={{
                  ...
                  <div class="icon-box text-center">
                    <a class="text-decoration-none" href="#!">
                      <img
                        ...
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/neurology.png"
                        alt="..."
                      />
                      <img
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="icon-box text-center">
                    <a class="text-decoration-none" href="#!">
                      <img
                        class="mb-3 deparment-icon"
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/eye-care.png"
                        alt="..."
                      />
                      <img
                        class="mb-3 deparment-icon-hover"
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="icon-box text-center">
                    <a class="text-decoration-none" href="#!">
                      <img
                        class="mb-3 deparment-icon"
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/cardiac.png"
                        alt="..."
                      />
                      <img
                        class="mb-3 deparment-icon-hover"
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="icon-box text-center">
                    <a class="text-decoration-none" href="#!">
                      <img
                        class="mb-3 deparment-icon"
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/heart.png"
                        alt="..."
                      />
                      <img
                        class="mb-3 deparment-icon-hover"
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/heart.svg"
                        alt="..."
                      />
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="icon-box text-center">
                    <a class="text-decoration-none" href="#!">
                      <img
                        class="mb-3 deparment-icon"
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/osteoporosis.png"
                        alt="..."
                      />
                      <img
                        class="mb-3 deparment-icon-hover"
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="icon-box text-center">
                    <a class="text-decoration-none" href="#!">
                      <img
                        class="mb-3 deparment-icon"
                        src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/icons/ent.png"
                        alt="..."
                      />
                      <img
                        class="mb-3 deparment-icon-hover"
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-md-5 col-xxl-6">
                <img
                  class="img-fluid"
                  src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/eye-care.png"
                  alt="..."
                />
              </div>
            ...
            <div class="row">
              <div class="col-12 py-3">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url(assets/img/gallery/about-us.png);background-position:top center;background-size:contain',
                  }}
                >
                  <img
                    src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/about-us.png"
                    style={{
                      backgroundPosition: 'top center',
                      backgroundSize: 'contain',
                    }}
        ...
        <section class="py-5">
          <div class="bg-holder bg-size">
            {' '}
            <img
              src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/about-bg.png"
              style={{
                backgroundPosition: 'top center',
                backgroundSize: 'contain',
              }}
            ...
            <div class="row align-items-center">
              <div class="col-md-6 order-lg-1 mb-5 mb-lg-0">
                <img
                  ...
                  src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/health-care.png"
                  alt="..."
                />
              </div>
            ...
            <div class="row">
              <div class="col-12 py-3">
                <div class="bg-holder bg-size">
                  {' '}
                  <img
                    src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/doctors-us.png"
                    style={{
                      backgroundPosition: 'top center',
                      backgroundSize: 'contain',
                    }}
        ...
        <section class="py-5">
          <div class="bg-holder bg-size">
            <img
              src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/doctors-bg.png"
              style={{
                backgroundPosition: 'top center',
                backgroundSize: 'contain',
              }}
                      ...
                      <div class="row h-100 m-lg-7 mx-3 mt-6 mx-md-4 my-md-7">
                        ...
                        <div class="col-md-4 mb-8 mb-md-0">
                          <div class="card card-span h-100 shadow">
                            <div class="card-body d-flex flex-column flex-center py-5">
                              <img
                                src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/leo-mario.png"
                                width="128"
                                alt="..."
                              />
                              ...
                              <div class="text-center">
                                <button
                                  class="btn btn-secondary hover-top rounded-pill border-0"
                                  type="submit"
                                >
                                  View Profile
                                </button>
            ...
            <div class="row">
              <div class="col-12 py-3">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url(assets/img/gallery/people.png);background-position:top center;background-size:contain',
                  }}
                >
                  <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/people.png"></img>
                </div>
        ...
        <section class="py-8">
          <div
            ...
            style={{
              backgroundImage:
                'url(assets/img/gallery/people-bg-1.png);background-position:center;background-size:cover',
            }}
          >
            <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/people-bg-1.png"></img>
          </div>
                    ...
                    <div class="row h-100">
                      <div class="col-sm-3 text-center">
                        <img
                          ...
                          alt=""
                        />
                        <h5 class="mt-3 fw-medium text-secondary">
                          Edward Newgate
                        </h5>
          ...
          <div class="container">
            <div class="row">
              <div
                ...
                style={{
                  backgroundImage:
                    'url(assets/img/gallery/dot-bg.png);background-position:bottom right;background-size:auto',
                }}
              >
                <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/dot-bg.png"></img>
              </div>

              <div class="col-lg-6 z-index-2 mb-5">
                <img
                  class="w-100"
                  src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/appointment.png"
                  alt="..."
                />
              </div>
              <div class="col-lg-6 z-index-2">
                <form class="row g-3">
                  ...
                  <div class="col-md-6">
                    <label class="visually-hidden" for="inputPhone">
                      Phone
                    </label>
                    <input
                      class="form-control form-livedoc-control"
            ...
            <div class="row">
              <div class="col-12 py-3">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url(assets/img/gallery/blog-post.png);background-position:top center;background-size:contain',
                  }}
                >
                  <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/blog-post.png"></img>
                </div>
        ...
        <section>
          <div
            ...
            style={{
              backgroundImage:
                'url(assets/img/gallery/dot-bg.png);background-position:top left;background-size:auto',
            }}
          >
            <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/dot-bg.png"></img>
          </div>
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card h-100 shadow card-span rounded-3">
                  <img
                    ...
                    src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/covid-19.png"
                    alt="news"
                  />
                  <div class="card-body">
                    <span class="fs--1 text-primary me-3">Health</span>
                    <svg
                      class="bi bi-calendar2 me-2"
                    ...
                    <span class="fs--1 text-900">Nov 21, 2021</span>
              ...
              <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card h-100 shadow card-span rounded-3">
                  ...
                  />
                  <div class="card-body">
                    <span class="fs--1 text-primary me-3">Lifestyle</span>
                    <svg
                      class="bi bi-calendar2 me-2"
                      xmlns="http://www.w3.org/2000/svg"
                      width="12"
                    ...
                    <span class="fs--1 text-900">Nov 25, 2021</span>
                    <span class="fs--1"></span>
                    <h5 class="font-base fs-lg-0 fs-xl-1 my-3">
              ...
              <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card h-100 shadow card-span rounded-3">
                  <img
                    class="card-img-top rounded-top-3"
                    src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/nicotine.png"
                    alt="news"
                  />
                  <div class="card-body">
                    <span class="fs--1 text-primary me-3">Health</span>
                    ...
                    <span class="fs--1 text-900">Nov 28, 2021</span>
                    <span class="fs--1"></span>
                    <h5 class="font-base fs-lg-0 fs-xl-1 my-3">
              ...
              <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card h-100 shadow card-span rounded-3">
                  <img
                    class="card-img-top rounded-top-3"
                    src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/treatment.png"
                    alt="news"
                  />
                  <div class="card-body">
                    <span class="fs--1 text-primary me-3">Health</span>
                    ...
                    <span class="fs--1 text-900">Nov 30, 2021</span>
                    <span class="fs--1"></span>
                    <h5 class="font-base fs-lg-0 fs-xl-1 my-3">
        ...
        <section class="bg-primary">
          <div
            ...
            style={{
              backgroundImage:
                'url(assets/img/gallery/cta-bg.png);background-position:center right;margin-top:-8.125rem;background-size:contain',
            }}
          >
            <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/cta-bg.png"></img>
          </div>
                ...
                <form class="row gx-2 gy-2 align-items-center">
                  <div class="col">
                    <div class="input-group-icon">
                      <label class="visually-hidden" for="inputEmailCta">
                        Address
                      </label>
                      <input
                        class="form-control form-livedoc-control form-cta-control text-soft-primary"
                        id="inputEmailCta"
                        type="email"
                        placeholder="Email"
                      />
                  ...
                  <div class="d-grid gap-3 col-sm-auto">
                    <button
                      class="btn btn-lg btn-light rounded-3 px-5 py-3"
                      type="submit"
                    >
                      Subscribe
                    </button>
        ...
        <section class="py-0 bg-secondary">
          <div
            ...
            style={{
              backgroundImage:
                'url(assets/img/gallery/dot-bg.png);background-position:top left;margin-top:-3.125rem;background-size:auto',
            }}
          >
            <img src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/dot-bg.png"></img>
          </div>
          <div class="container">
            <div class="row py-8">
              <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0">
                <a class="text-decoration-none" href="#">
                  <img
                    src="https://themewagon.github.io/live-doc/v1.0.0/assets/img/gallery/footer-logo.png"
                    height="51"
                    alt=""
                  />
                </a>
